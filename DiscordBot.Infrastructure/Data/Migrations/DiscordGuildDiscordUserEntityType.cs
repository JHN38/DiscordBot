...
namespace DiscordBot.Infrastructure.Data.Migrations
{
    ...
    public partial class DiscordGuildDiscordUserEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var guildsId = runtimeEntityType.AddProperty(
                "GuildsId",
                typeof(ulong),
        ...
        {
            var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("GuildsId") },
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "DiscordUserGuilds");
